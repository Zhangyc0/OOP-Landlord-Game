...
void Strategy::pickSeqSingles(QVector<QVector<QVector<Card>>> &allSeqRecord, const QVector<QVector<Card>> &seqInherited,
                              QVector<Card> cards) {
    QVector<QVector<Card> > allSeqScheme = Strategy(player, cards).findHand(CardGroups(Group_Seq_Single, Card_Begin, 0),
                                                                            false);
...
QVector<Card> Strategy::playFirst() {
    ...
    QVector<QVector<Card> > bombArray = Strategy(player, leftCards).findHand(CardGroups(Group_Bomb, Card_Begin, 0),
                                                                             false);
    ...
    QVector<QVector<Card> > planeArray = Strategy(player, leftCards).findHand(CardGroups(Group_Plane, Card_Begin, 0),
                                                                              false);
    ...
    QVector<QVector<Card> > tripleArray = Strategy(player, leftCards).findHand(CardGroups(Group_Triple, Card_Begin, 0),
                                                                               false);
    ...
    QVector<QVector<Card> > seqPairArray = Strategy(player, leftCards).findHand(
